...
class UserController {
    ...
    config() {
        //Login
        this.router.get(utilities_1.Routers.login, express_validator_1.body(utilities_1.inputUser.name)
            .exists()
            ...
            .trim()
            .escape(), user_router_1.default.login);
        //Registro
        this.router.get(utilities_1.Routers.register, [
            ...
            express_validator_1.body(utilities_1.inputUser.age)
                ...
                .trim()
                .escape(),
        ], user_router_1.default.register);
        //Usuarios
        this.router.get(utilities_1.Routers.users, checkToken_1.default, user_router_1.default.getUsers);
        //Perfil
        this.router.get(utilities_1.Routers.user, checkToken_1.default, user_router_1.default.getUser);
        //Eliminar Usuario (por id)
        this.router.get(utilities_1.Routers.userdelete, checkToken_1.default, user_router_1.default.deleteUser);
        //Actualizar Usuario (por id)
        this.router.get(utilities_1.Routers.userupdate, checkToken_1.default, user_router_1.default.updateUser);
    }
}
